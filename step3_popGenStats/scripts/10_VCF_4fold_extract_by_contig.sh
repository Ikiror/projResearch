...
#SBATCH --output=/data/users/aikiror/researchProject/pipeline/step3_popGenStats/logFiles/10_VCF_4fold_extract_by_contig/output_%A_%a.o
#SBATCH --error=/data/users/aikiror/researchProject/pipeline/step3_popGenStats/logFiles/10_VCF_4fold_extract_by_contig/error_%A_%a.e
#SBATCH --partition=pibu_el8

#to run: sbatch path/to/file
#array job to extract vcf at 4-fold degenerate sites
...
#need to generate 4fold by contig
...
#Using same contig list as 0-fold extraction; identical contig names
