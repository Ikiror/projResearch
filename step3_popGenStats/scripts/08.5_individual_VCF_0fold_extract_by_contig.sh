...
#SBATCH --output=/data/users/aikiror/researchProject/pipeline/step3_popGenStats/logFiles/08.5_individual_VCF_0fold_extract_by_contig/output_%J.o
#SBATCH --error=/data/users/aikiror/researchProject/pipeline/step3_popGenStats/logFiles/08.5_individual_VCF_0fold_extract_by_contig/error_%J.e
#SBATCH --partition=pibu_el8


#this script will run on an individual contig/scaffold as opposed to multiple as in  08_VCF_0fold_extract_by_contig.sh
#to run: sbatch /path/to/script contig_name
#job to extract vcf at 0-fold degenerate sites
...
# Output directories
#script is 08.5 but output same as 08 script
